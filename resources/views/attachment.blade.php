<div class="tab-pane" id="attachments" role="tabpanel">
    <form class="dropzone dropzone-multiple p-0" id="my-awesome-dropzone" data-dropzone="data-dropzone" action="#!">
        ...
        <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column comment-log-attachment-previews">
            <div class="d-flex media mb-3 pb-3 border-bottom btn-reveal-trigger"><img class="dz-image" style="width: 65px !important; height: 65px !important" src="../../../assets/img/generic/image-file-2.png" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
