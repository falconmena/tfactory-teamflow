<div class="card mb-3">
    <div class="card-body">
        ...
        <div class="tab-content pt-4" id="nav-tabContent">
            ...
            <div class="tab-pane" id="log-note" role="tabpanel">
                <div class="row px-2">
                    <div class="col-12 d-flex">
                        ...
                        <div class="flex-1 ms-2">
                            <h6 class="mb-0 fs-0">Tasneem Aldirini</h6><a class="text-800 fs--1" href="#!"><span class="fw-semi-bold">Sales</span><span class="ms-1 text-500">&lt;t.dirini@techs.com&gt;</span></a>
                        </div>
                    </div>
                    <div class="col-12 mt-3 mb-2">
                        <form action="">
            ...
            @include('tfactory-teamflow::attachment')
        </div>
