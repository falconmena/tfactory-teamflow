<div class="modal fade" id="schedule-activity-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content position-relative">
            ...
            <form id="teamflow_activity_form" autocomplete="off" action="{{route('teamflow.activity.store')}}" method="POST">
            @csrf
                            ...
                            <div class="col-12 col-lg-6 mb-3">
                                ...
                                <select name="activity_type" class="form-control fs--1">
                                    ...
                                    @foreach (Config::get('tfactory-teamflow.activity_type') as $key => $activity_type)
                                      <option value="{{$key}}" selected="selected">{{$activity_type}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-lg-6 mb-3">
            ...
            <div class="modal-footer px-4 pb-3">
                ...
                <button class="btn btn-primary fs--1 py-2 px-4 my-2 mx-0" id="teamflow_schedule_activity" type="button">Schedule</button>
            </div>
            </form>
        </div>
    </div>
