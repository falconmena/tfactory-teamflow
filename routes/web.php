...
Route::group(['prefix' => 'teamflow'], function () {
    ...
    Route::get('/attachments/recent', [Techsfactory\TfactoryTeamflow\Http\Controllers\AttachmentController::class, 'getRecentFiles'])->name('teamflow.attachments.recent');
    Route::delete('/attachments/delete/{id}', [Techsfactory\TfactoryTeamflow\Http\Controllers\AttachmentController::class, 'delete'])->name('teamflow.attachments.delete');
});